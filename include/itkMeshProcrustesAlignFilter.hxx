...
MeshProcrustesAlignFilter<TInputMesh, TOutputMesh>::MeshProcrustesAlignFilter()
{
...
MeshProcrustesAlignFilter<TInputMesh, TOutputMesh>::GetOutput(unsigned int idx)
{
...
template <class TInputMesh, class TOutputMesh>
void
MeshProcrustesAlignFilter<TInputMesh, TOutputMesh>::SetNumberOfInputs(unsigned int num)
{
...
template <class TInputMesh, class TOutputMesh>
void
MeshProcrustesAlignFilter<TInputMesh, TOutputMesh>::SetInput(unsigned int idx, InputMeshType * mesh)
{
...
template <class TInputMesh, class TOutputMesh>
void
MeshProcrustesAlignFilter<TInputMesh, TOutputMesh>::GenerateData()
{
...
MeshProcrustesAlignFilter<TInputMesh, TOutputMesh>::GetMeshCenter(unsigned int idx)
{
...
MeshProcrustesAlignFilter<TInputMesh, TOutputMesh>::GetProcrustesMatch(unsigned int     idx,
                                                                       OutputMeshType * targetMesh,
                                                                       TranslationType  targetCenter)
{
...
template <class TInputMesh, class TOutputMesh>
void
MeshProcrustesAlignFilter<TInputMesh, TOutputMesh>::CalculateMean()
{
