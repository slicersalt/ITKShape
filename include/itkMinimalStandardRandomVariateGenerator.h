...
#include "Mesh3DProcrustesAlignFilterExport.h"
 ...
 */
class Mesh3DProcrustesAlignFilter_EXPORT MinimalStandardRandomVariateGenerator : public RandomVariateGeneratorBase
{
public:
